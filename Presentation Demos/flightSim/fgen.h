    ...
    */
    ...
    public:
        ...
        Buoyancy(const Vector3 &cOfB,
            marb maxDepth, marb volume, marb waterHeight,
            marb liquidDensity = 1000.0f);
