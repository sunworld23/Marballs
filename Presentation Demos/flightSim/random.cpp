...
marb Random::randomReal(marb min, marb max)
{
    return randomReal() * (max-min) + min;
}

marb Random::randomReal(marb scale)
{
...
marb Random::randomBinomial(marb scale)
{
...
Vector3 Random::randomVector(marb scale)
{
    return Vector3(
...
Vector3 Random::randomXZVector(marb scale)
{
    return Vector3(
        randomBinomial(scale),
        0,
