...
{
protected:
    marballs::ParticleWorld world;
    marballs::Particle *particleArray;
    marballs::GroundContacts groundContactGenerator;
...
//
 ...
 protected:
    ...
    marballs::Contact contacts[maxContacts];

    // Holds the collision data structure for collision detection.
    marballs::CollisionData cData;

    // Holds the contact resolver.
    marballs::ContactResolver resolver;
    ...
    virtual void updateObjects(marballs::real duration) = 0;
